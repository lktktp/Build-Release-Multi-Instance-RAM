...
namespace RBX_Alt_Manager.Classes
{
    internal class RobloxProcess
    {
        ...
        public RobloxProcess(Process process)
        {
            ...
            // MULTI-INSTANCE FIX: Increased initial grace period from 90s to 180s
            // Multiple instances take longer to connect when launching sequentially
            DisconnectedTime = DateTime.Now.AddSeconds(180);
